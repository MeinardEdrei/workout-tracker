...
router.put('/:id/days/:dayId/exercises/:exId', async (req, res) => {
  try {
    ...
    const fields = [...structuralFields, 'todaySetLogs', 'todaySetLogsDate', 'checked', 'lastCheckedDate', 'todaySwap', 'todaySwapDate', 'lastSwapName', 'lastSwapImageUrl', 'lastSwapMuscleTargets', 'lastSwapDate'];
